  ...
  return (
    <>
      ...
      >
        <Container>
          {error && (
            <Alert severity="error" sx={{ mb: 2 }} onClose={() => {}}>{error}</Alert>
          )}
          <Card>
            <CardContent>
              <Typography
              ...
              <div style={{ display: 'flex', flexDirection: 'row', gap: '1rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <div style={{ display: 'flex', alignItems: 'center', flexDirection: 'column', gap: '0.5rem' }}>
                    <IconButton color='primary' onClick={handleSend} disabled={loading} loading={loading}>
                      <SendIcon />
                    </IconButton>
                      <Typography variant="caption" style={{userSelect: 'none'}}>
                        {timer}s
                      </Typography>
                  </div>
                </div>
